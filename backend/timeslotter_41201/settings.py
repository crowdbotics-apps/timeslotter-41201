"""
Django settings for timeslotter_41201 project.
...
ROOT_URLCONF = 'timeslotter_41201.urls'
...
WSGI_APPLICATION = 'timeslotter_41201.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "timeslotter_41201 API",
    "DESCRIPTION": "API documentation for timeslotter_41201 App",
    "VERSION": "v1",
}
